      ...
      >
        ...
        >
          ...
          <div className="relative mb-5">
            ...
            <div className="w-20 h-20 rounded-full bg-gradient-to-tr from-blue-600 to-indigo-600 flex items-center justify-center text-3xl font-bold uppercase shadow-lg border-2 border-white/20 relative z-10">
